...
class SegmentationNN(pl.LightningModule):
    ...
    def __init__(self, num_classes=23, hparams=None):
        ...
        print("1st Conv", encoder_par[0].shape)
        print("2nd Conv", encoder_par[2].shape)
        print("3rd Conv", encoder_par[4].shape)
        print("4th Conv", encoder_par[6].shape)
        print("5th Conv", encoder_par[8].shape)
